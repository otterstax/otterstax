...
Creates files directly in mounted volumes.
"""
import os
import random
...
def create_test_data():
    ...
    campaigns_sql = """-- Create campaigns table
...
"""
    ...
    impressions_sql = """-- Create impressions table
...
VALUES ({i}, '{campaign_name}', '{campaign_length}', {budget});\n"""
    ...
    print("Generating impressions for campaigns...")
