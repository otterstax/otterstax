...
pause; bash 01_seed_intl.sh || exit $?

title "5b  ·  CREATE SOURCE orders_intl over the 2nd feed"
pause; psql_run 02_create_source_intl.sql || exit $?
