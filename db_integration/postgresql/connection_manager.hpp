...
namespace db_conn {
    ...
    public:
        ...
        PgConnectionManager(std::pmr::memory_resource* res, std::shared_ptr<pgc::ConnectorManager> connector_manager);
        ...
        using dispatch_traits = actor_zeta::dispatch_traits<&PgConnectionManager::execute>;
