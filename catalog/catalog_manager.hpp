...
namespace mysqlc {
    ...
    public:
        ...
        add_connection_schema(collection_full_name_t name);

        actor_zeta::unique_future<void>
        remove_connection_schema(std::string uuid);
    ...
    private:
        ...
        catalog::catalog_error add_connection_schema_sync(collection_full_name_t name);
    };
} // namespace mysqlc
