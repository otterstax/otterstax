...
arrow::Status ChunkBatchReader::ReadNext(std::shared_ptr<arrow::RecordBatch>* out) {
    while (next_ < chunks_.size()) {
        ...
        for (size_t i = 0; i < cur.column_count(); i++) {
            ...
            auto index = schema_ptr_->GetFieldIndex(cur.data[i].type().alias());
            if (index == -1) {
            ...
            for (size_t j = 0; j < cur.size(); j++) {
                auto value = cur.value(i, j);
                bool is_null = value.is_null();

                switch (field_type->id()) {
                    case arrow::Type::BOOL:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::BooleanBuilder*>(builders[index].get()),
                                                            value.value<bool>(),
                                                            is_null));
                        break;
                    case arrow::Type::INT8:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::Int8Builder*>(builders[index].get()),
                                                            value.value<int8_t>(),
                                                            is_null));
                        break;
                    case arrow::Type::INT16:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::Int16Builder*>(builders[index].get()),
                                                            value.value<int16_t>(),
                                                            is_null));
                        break;
                    case arrow::Type::INT32:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::Int32Builder*>(builders[index].get()),
                                                            value.value<int32_t>(),
                                                            is_null));
                        break;
                    case arrow::Type::INT64:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::Int64Builder*>(builders[index].get()),
                                                            value.value<int64_t>(),
                                                            is_null));
                        break;
                    case arrow::Type::UINT8:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::UInt8Builder*>(builders[index].get()),
                                                            value.value<uint8_t>(),
                                                            is_null));
                        break;
                    case arrow::Type::UINT16:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::UInt16Builder*>(builders[index].get()),
                                                            value.value<uint16_t>(),
                                                            is_null));
                        break;
                    case arrow::Type::UINT32:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::UInt32Builder*>(builders[index].get()),
                                                            value.value<uint32_t>(),
                                                            is_null));
                        break;
                    case arrow::Type::UINT64:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::UInt64Builder*>(builders[index].get()),
                                                            value.value<uint64_t>(),
                                                            is_null));
                        break;
                    case arrow::Type::FLOAT:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::FloatBuilder*>(builders[index].get()),
                                                            value.value<float>(),
                                                            is_null));
                        break;
                    case arrow::Type::DOUBLE:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::DoubleBuilder*>(builders[index].get()),
                                                            value.value<double>(),
                                                            is_null));
                        break;
                    case arrow::Type::STRING:
                        ARROW_RETURN_NOT_OK(populateBuilder(static_cast<arrow::StringBuilder*>(builders[index].get()),
        ...
        *out = arrow::RecordBatch::Make(schema_ptr_, cur.size(), columns);
