...
def main(local=False):
    ...
    # Test 1: Basic JOIN with WHERE and ORDER BY
...
ORDER BY impressions.clicks DESC;"""
    ...
    # Test 2: JOIN with complex WHERE
...
ORDER BY impressions.clicks DESC;"""
    ...
    # Test 5: JOIN with AND condition
...
ORDER BY clicks;"""
    ...
    # Test 6: JOIN with multiple conditions
...
WHERE budget > 80000 OR budget < 90000;"""
    ...
    # Test 7: Simple SELECT from single table
    ...
    # Test 8: SELECT from impressions table
