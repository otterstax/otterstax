...
namespace mysql {
    ...
    public:
        ...
        // Grouped at the end of the class to avoid merge conflicts with the
        // parallel #524 (drop/catalog_resolve) work. Each follows the
        // get_tables handler contract: actor handler, result delivered through
        // a shared_data cv_wrapper, no exceptions thrown.
