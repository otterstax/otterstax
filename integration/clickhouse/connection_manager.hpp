...
namespace db {
    ...
    public:
        ...
        ClickhouseManager(std::pmr::memory_resource* res, std::shared_ptr<ch::ConnectorManager> connector_manager);
        ...
        using dispatch_traits = actor_zeta::dispatch_traits<&ClickhouseManager::execute>;
    ...
    private:
        ...
        std::shared_ptr<ch::ConnectorManager> connector_manager_;
        log_t log_;
