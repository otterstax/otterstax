...
namespace db_conn {
    ...
    class S3ConnectionManager final : public actor_zeta::cooperative_supervisor<S3ConnectionManager> {
    public:
        S3ConnectionManager(std::pmr::memory_resource* res,
    ...
    private:
        std::shared_ptr<s3c::ConnectorManager> connector_manager_;
