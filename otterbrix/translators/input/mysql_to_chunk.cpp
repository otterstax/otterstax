    ...
    namespace impl {
        ...
        void set_int8(data_chunk_t& chunk, const boost::mysql::rows_view& rows, size_t row_index, size_t column_index) {
            ...
            chunk.set_value(
                column_index,
                row_index,
                types::logical_value_t{chunk.resource(), static_cast<int8_t>(rows.at(row_index).at(column_index).as_int64())});
        }
        ...
        set_int16(data_chunk_t& chunk, const boost::mysql::rows_view& rows, size_t row_index, size_t column_index) {
            ...
            chunk.set_value(
                column_index,
                row_index,
                types::logical_value_t{chunk.resource(), static_cast<int16_t>(rows.at(row_index).at(column_index).as_int64())});
        }
        ...
        set_int32(data_chunk_t& chunk, const boost::mysql::rows_view& rows, size_t row_index, size_t column_index) {
            ...
            chunk.set_value(
                column_index,
                row_index,
                types::logical_value_t{chunk.resource(), static_cast<int32_t>(rows.at(row_index).at(column_index).as_int64())});
        }
        ...
        set_int64(data_chunk_t& chunk, const boost::mysql::rows_view& rows, size_t row_index, size_t column_index) {
            ...
            chunk.set_value(
                column_index,
                row_index,
                types::logical_value_t{chunk.resource(), static_cast<int64_t>(rows.at(row_index).at(column_index).as_int64())});
        }
        ...
        set_uint8(data_chunk_t& chunk, const boost::mysql::rows_view& rows, size_t row_index, size_t column_index) {
            ...
            chunk.set_value(
                column_index,
                row_index,
                types::logical_value_t{chunk.resource(), static_cast<uint8_t>(rows.at(row_index).at(column_index).as_uint64())});
        }
        ...
        set_uint16(data_chunk_t& chunk, const boost::mysql::rows_view& rows, size_t row_index, size_t column_index) {
            ...
            chunk.set_value(
                column_index,
                row_index,
                types::logical_value_t{chunk.resource(), static_cast<uint16_t>(rows.at(row_index).at(column_index).as_uint64())});
        }
        ...
        set_uint32(data_chunk_t& chunk, const boost::mysql::rows_view& rows, size_t row_index, size_t column_index) {
            ...
            chunk.set_value(
                column_index,
                row_index,
                types::logical_value_t{chunk.resource(), static_cast<uint32_t>(rows.at(row_index).at(column_index).as_uint64())});
        }
        ...
        set_uint64(data_chunk_t& chunk, const boost::mysql::rows_view& rows, size_t row_index, size_t column_index) {
            ...
            chunk.set_value(
                column_index,
                row_index,
                types::logical_value_t{chunk.resource(), static_cast<uint64_t>(rows.at(row_index).at(column_index).as_uint64())});
        }
        ...
        void set_blob(data_chunk_t& chunk, const boost::mysql::rows_view& rows, size_t row_index, size_t column_index) {
            ...
            chunk.set_value(column_index, row_index, types::logical_value_t{chunk.resource(), std::string(blob.begin(), blob.end())});
        }
