...
def validate_table_schemas(client, expected_schemas):
    ...
    for attempt in range(1, max_attempts + 1):
        ...
        if attempt < max_attempts:
            print(f"No tables data received yet, retrying ({attempt}/{max_attempts})...")
...
def main(local=False):
    ...
    # Expected schemas for PostgreSQL products table
...
def main_test():
    ...
    parser = argparse.ArgumentParser(description='Validate PostgreSQL table schemas')
    ...
    try:
        ...
        print("\n" + "="*70)
        print("\033[92m✅ ALL TESTS PASSED - Schema Validation PostgreSQL\033[0m")
        print("="*70)
        ...
        print("\n" + "="*70)
        print(f"\033[91m❌ TEST FAILED - Schema Validation PostgreSQL\033[0m")
        print("="*70)
