...
CH_URL="http://0.0.0.0:8085/add_ch_connection"
...
FILE="connection_clickhouse_local.json"
echo "Sending ClickHouse request with $FILE..."
curl -X POST "$CH_URL" -H "Content-Type: application/json" -d @"$FILE"
echo -e "\n"